...
def parse_resume_with_groq(
    ...
    if output_format.lower() == "json" and output_preset == "full":
        system_prompt = (
            ...
            "  \"summary\": string | null,\n"
            "  \"education\": [\n"
            "    {\"institution\": string, \"degree\": string|null, \"field\": string|null, \"start\": string|null, \"end\": string|null, \"grade_type\": \"CGPA\"|\"Percentage\"|null, \"grade_value\": string|null}\n"
            "  ],\n"
            "  \"experience\": [\n"
            "    {\"title\": string, \"company\": string, \"location\": string|null, \"start\": string|null, \"end\": string|null, \"bullets\": string[]}\n"
            "  ],\n"
            "  \"projects\": [\n"
            "    {\"name\": string, \"description\": string|null, \"tech_stack\": string[]}\n"
            "  ],\n"
            "  \"skills\": {\"programming_languages\": string[], \"frameworks_libraries\": string[], \"tools\": string[], \"other\": string[]}\n"
            "}\n"
            "Rules:\n"
            "- Populate as many fields as possible from the text.\n"
            "- Use null where not available.\n"
            "- Normalize phone in international format when possible.\n"
            "- Detect grade_type as CGPA or Percentage when present; place numeric value in grade_value.\n"
            "- Do not summarize; faithfully extract.\n"
